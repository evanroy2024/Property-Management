"""
Django settings for lpcproperty project.
...
INSTALLED_APPS = [
    ...
    'walkthroughreport.apps.WalkthroughreportConfig',
    'clientmanager',
    'contacttogether',
    'contentpage',
...
WSGI_APPLICATION = 'lpcproperty.wsgi.application'
