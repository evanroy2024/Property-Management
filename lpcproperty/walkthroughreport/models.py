...
class WalkthroughReport(models.Model):
    ...
    breakfast1_remarks = models.TextField(blank=True, null=True)
    ...
    breakfast2_remarks = models.TextField(blank=True, null=True)
    ...
    breakfast3_remarks = models.TextField(blank=True, null=True)
    ...
    breakfast4_remarks = models.TextField(blank=True, null=True)
    ...
    breakfast5_remarks = models.TextField(blank=True, null=True)
